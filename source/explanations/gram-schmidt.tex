...
\begin{flalign*}
	u_n = v_k - \sum_{j=1}^{k-1} \text{proj}_{u_j} (v_k) 
\end{flalign*}

\par \noindent We conclude with normalizing \(u_1\), \(u_2\), ... \(u_n\) to obtain the orthonormal set: 

\begin{flalign*}
	 \{\frac{u_1}{|| \vec u_1 ||},\frac{u_2}{|| \vec u_2 ||},\frac{u_3}{|| \vec u_3 ||} ... \frac{u_n}{|| \vec u_n ||} \} =
...
\vec u_3 = \vec v_3 - \text{proj}_{u_1} (v_3) - \text{proj}_{u_2} (\vec v_3)
		...
		\begin{flalign*}
		\vec u_3 = <0,1,1> - \frac{(1)(0) + (2)(0) + (0)(1)}{(0)(0) + (0)(0) + (1)(1)}<1,2,0> - \frac{(1)(8)+(2)(1) + (0)(0)}{(1)(1) + (2)(2) + (0)(0)}<6,-3,-6> \\
	...
	\end{flalign*}
		...
		\begin{flalign*}
			...
			\hat{u_3} =  \frac{9}{\sqrt{45}} <\frac{4}{9}, -\frac{2}{9}, \frac{5}{9}>
		\end{flalign*}
